...
class EmailTemplates {
    constructor() {
        this.PASSWORD_RESET_REQUEST_TEMPLATE = `
                        <!DOCTYPE html>
                        <html lang="en">
                        <head>
                        <meta charset="UTF-8">
    ...
    ADMIN_COVERING_CONFIRMATION_TEMPLATE(details, adminURL) {
        return `<!DOCTYPE html>
            <html lang="fr">
            <head>
                <meta charset="UTF-8">
...
exports.Emailtemplates = new EmailTemplates();
