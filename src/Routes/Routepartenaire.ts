...
const router: Router = express.Router();
 ...
 class Routepartenaire{
    ...
    private initRoutes(){
        ...
        router.post('/partenaire/campagne/:nom_societe',ControllerpartenairInstance.verifyToken,ControllerpartenairInstance.createPubliciteetpay)
        //Crud avec token
        ...
        router.post('/partenaire/covering_ads/:nom_societe',ControllerpartenairInstance.verifyToken,ControllerpartenairInstance.createcovering);
        //get User by token 
